...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_0p1 = RealNumber('0.1'); _sage_const_2 = Integer(2); _sage_const_0p2 = RealNumber('0.2'); _sage_const_120 = Integer(120); _sage_const_5 = Integer(5); _sage_const_3 = Integer(3); _sage_const_9 = Integer(9); _sage_const_10 = Integer(10); _sage_const_50 = Integer(50); _sage_const_6 = Integer(6); _sage_const_0p05 = RealNumber('0.05')
import numpy as np
...
def spline_avg(f):
    a = f.list()[_sage_const_0 ][_sage_const_0 ]
    b = f.list()[-_sage_const_1 ][_sage_const_0 ]
...
def splines_fix_center(x, y, center=(_sage_const_0 ,_sage_const_0 )):
    x_bar = spline_avg(x)
    y_bar = spline_avg(y)
...
_, rotated_splines = flow_curvature(kappa, srange, arange, acount, center=(_sage_const_6 ,_sage_const_0 ), step=_sage_const_0p05 )
