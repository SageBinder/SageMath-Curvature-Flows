...
_sage_const_1 = Integer(1); _sage_const_3 = Integer(3); _sage_const_0 = Integer(0); _sage_const_0p1 = RealNumber('0.1'); _sage_const_2 = Integer(2); _sage_const_5 = Integer(5); _sage_const_0p2 = RealNumber('0.2'); _sage_const_0p01 = RealNumber('0.01'); _sage_const_4 = Integer(4); _sage_const_6 = Integer(6); _sage_const_0p766 = RealNumber('0.766'); _sage_const_0p091 = RealNumber('0.091'); _sage_const_0p5 = RealNumber('0.5'); _sage_const_0p25 = RealNumber('0.25'); _sage_const_8 = Integer(8); _sage_const_12 = Integer(12); _sage_const_7 = Integer(7); _sage_const_0p0001 = RealNumber('0.0001'); _sage_const_2001 = Integer(2001); _sage_const_10 = Integer(10); _sage_const_0p00001 = RealNumber('0.00001'); _sage_const_100 = Integer(100); _sage_const_0p05 = RealNumber('0.05'); _sage_const_20 = Integer(20); _sage_const_80 = Integer(80)# This code for visualizing Ricci flow in the special case of surfaces of revolution of genus 0
