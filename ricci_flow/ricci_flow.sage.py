...
_sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_5 = Integer(5); _sage_const_0p2 = RealNumber('0.2'); _sage_const_1 = Integer(1); _sage_const_0p1 = RealNumber('0.1'); _sage_const_0p01 = RealNumber('0.01'); _sage_const_4 = Integer(4); _sage_const_6 = Integer(6); _sage_const_0p5 = RealNumber('0.5'); _sage_const_0p25 = RealNumber('0.25'); _sage_const_0p021 = RealNumber('0.021'); _sage_const_0p598 = RealNumber('0.598'); _sage_const_3 = Integer(3); _sage_const_0p0001 = RealNumber('0.0001'); _sage_const_3001 = Integer(3001); _sage_const_10 = Integer(10); _sage_const_20 = Integer(20); _sage_const_80 = Integer(80)# This code for visualizing Ricci flow in the special case of surfaces of revolution of genus 0
...
N = _sage_const_3001  # The simulation will run for at most N timesteps. If it encounters a numerical error earlier, it will terminate and save all animations up until that timestep.
