...
_sage_const_1 = Integer(1); _sage_const_3 = Integer(3); _sage_const_0 = Integer(0); _sage_const_0p1 = RealNumber('0.1'); _sage_const_2 = Integer(2); _sage_const_5 = Integer(5); _sage_const_0p2 = RealNumber('0.2'); _sage_const_0p01 = RealNumber('0.01'); _sage_const_4 = Integer(4); _sage_const_6 = Integer(6); _sage_const_0p021 = RealNumber('0.021'); _sage_const_0p598 = RealNumber('0.598'); _sage_const_0p5 = RealNumber('0.5'); _sage_const_0p25 = RealNumber('0.25'); _sage_const_2p5 = RealNumber('2.5'); _sage_const_8 = Integer(8); _sage_const_20 = Integer(20); _sage_const_7 = Integer(7); _sage_const_0p0001 = RealNumber('0.0001'); _sage_const_2001 = Integer(2001); _sage_const_235 = Integer(235); _sage_const_0p00001 = RealNumber('0.00001'); _sage_const_100 = Integer(100); _sage_const_0p05 = RealNumber('0.05'); _sage_const_80 = Integer(80)# This code for visualizing Ricci flow in the special case of surfaces of revolution of genus 0
    ...
    try:
        ...
        if i % plot_gap == _sage_const_0 :
            ...
            if animate_tissot:
                ...
                _, _, ellipses = tissot(make_g(h, m), vrange=(tissot_eps, pi-tissot_eps), sq_len=_sage_const_1 , ucount=_sage_const_3 , vcount=_sage_const_7 )
                tissot_plot = Graphics()
                tissot_plot += sum([ellipse((x*tissot_theta_placement_scale, y*tissot_rho_placement_scale), k1*tissot_scale, k2*tissot_scale, theta, axes=False, thickness=_sage_const_1 , fill=True) for x, y, k1, k2, theta in ellipses])
                tissot_plot.set_axes_range(xmin=-tissot_theta_padding, xmax=tissot_theta_placement_scale*_sage_const_2 *pi + tissot_theta_padding, ymin=-tissot_rho_padding, ymax=tissot_rho_placement_scale*pi + tissot_rho_padding)
