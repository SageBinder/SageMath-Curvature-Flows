...
def xy_splines_from_hm(h, m, srange=(_sage_const_0 , pi), step_size=_sage_const_0p1 , eps=_sage_const_0p01 ):
    ...
    def x(rho):
        ...
        return numerical_integral(integrand, eps, rho)[_sage_const_0 ]
...
x, y = xy_splines_from_hm(h, m, srange, step_size=_sage_const_0p1 , eps=_sage_const_0 )
...
for i in range(N):
    ...
    h.append((_sage_const_0 , sqrt_m.derivative(_sage_const_0 )))
    h.append((pi, sqrt_m.derivative(pi)))

    x, y = xy_splines_from_hm(h, m, srange, eps=_sage_const_0 )
    
    if i % plot_gap == _sage_const_0 :
        plots.append(parametric_plot((x, y), (_sage_const_0 , pi)))
